...
<title>Quản trị hệ thống -- Copyright � 2010 Giasoc Software Group Inc </title>
...
<div id="head">
    ...
    <div id="menu"><span>Xin chào, <strong><?php echo $this->_var['visitor']['user_name']; ?></strong> <a href="index.php?act=logout">[Thoát]</a> <a href="<?php echo $this->_var['site_url']; ?>/index.php" target="_blank">[Xem Shop]</a></span>
    <a href="javascript:;" class="menu_btn1" id="iframe_refresh">LàmMới</a>
    <a href="javascript:;" class="menu_btn2" id="clear_cache">XóaCache</a>
    ...
    <div id="left">
        <div id="leftMenus">
            ...
            <dl id="history" class="history">
                <dt>
                    <a class="ico2" id="historyText" href="#">Hoạt động cuối</a>
                </dt>
            </dl>
         </div>
    </div>
